...
def myAtoi(str):
    ...
    _res = pattern.match(str)
    if _res:
        ret = int(_res.group())
        if -2147483648 <= ret <= 2147483647:
            return ret
        return -2147483648 if ret < -2147483648 else 2147483647
    return 0
# 1047 / 1047 test cases passed. Runtime: 95 ms  99.37 %

"""
一点点感悟: 1、会多次重复使用的第三方模块应该在文件头部导入
           2、使用正则时应该先 compile后在匹配  可以提高性能
"""

if __name__ == "__main__":
    print(myAtoi('w-1234545'))
